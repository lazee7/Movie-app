...
const NavBar = () => {
  return (
    <nav className='grid gap-4 place-content-center grid-cols-4 md:gap-10 mx-1 mt-2 md:m-0 rounded-2xl py-2 px-2 justify-between w-full md:py-7 md:pl-8 md:pr-28'>
      <Logo />
      <Search />
